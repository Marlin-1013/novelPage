	...
	<div class="container">
		<div class="row">
			<form method="post" action="writeAction.jsp">
				...
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">소설 생성</th>						
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td><textarea class="form-control" placeholder="소개" name="introduce" maxlength="2048" style="height: 350px"></textarea></td>						
					</tr>
				</tbody>
			</table>
